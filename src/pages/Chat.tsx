...
const Chat = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4 max-w-md mx-auto w-full bg-white">
        {messages.map((msg) => (
          <div
            key={msg.id}
          ...
          >
            <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${msg.isMe
              ...
              <p>{msg.text}</p>
              <p className={`text-xs mt-1 ${msg.isMe ? 'text-blue-100' : 'text-buddy-text-light'
                }`}>
                {msg.time}
              </p>
            </div>
